        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="verification-code-wrapper">
                ...
                <div class="verification-area">
                    ...
                    <form action="{{route('user.withdraw.confirm')}}" method="POST" class="submit-form">
                        ...
                        <div class="mb-3">
                            ...
                            <p>
                                ...
                                @lang('If you don\'t get any code'), <a href="{{route('user.withdraw.sendVerifyCode')}}"> @lang('Try again')</a>
