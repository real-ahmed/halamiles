                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-none">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="amount" class="form-control form--control" value="{{ session('boosting_data')['price'] }}" autocomplete="off" required>
                            ...
                            <div class="mt-3 preview-details d-none">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <span><span class="fw-bold">{{ showAmount(session('boosting_data')['price']) }}</span> {{__($general->cur_text)}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between">
        ...
        (function ($) {
            ...
            $('select[name=gateway]').change(function(){
                ...
                if (resource.currency != '{{ $general->cur_text }}') {
                    var rateElement = `<span>@lang('Conversion Rate')</span> <span><span  class="fw-bold">1 {{__($general->cur_text)}} = <span class="rate">${rate}</span>  <span class="base-currency">${resource.currency}</span></span></span>`;
