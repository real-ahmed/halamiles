    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                ...
                <div class="widget-two__content">
                <h3 class="text-white">{{ $widget['total_package'] }}</h3>
                <p class="text-white">@lang('Total Package')</p>
                </div>
                <a href="{{ route('admin.package.index') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                ...
                <div class="widget-two__content">
                <h3 class="text-white">{{ $widget['total_coupon'] }}</h3>
                <p class="text-white">@lang('Total Coupon')</p>
                </div>
                <a href="{{ route('admin.coupon.all') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--14">
                ...
                <div class="widget-two__content">
                <h3 class="text-white">{{ $widget['active_coupon'] }}</h3>
                <p class="text-white">@lang('Active Coupon')</p>
                </div>
                <a href="{{ route('admin.coupon.active') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                ...
                <div class="widget-two__content">
                <h3 class="text-white">{{ $widget['total_store'] }}</h3>
                <p class="text-white">@lang('Total Store')</p>
                </div>
                <a href="{{ route('admin.store.all') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
