                    ...
                    <form action="{{route('admin.language.store.key',$lang->id)}}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="key" name="key" value="{{old('key')}}" required> </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="value" name="value" value="{{old('value')}}" required> </textarea>
