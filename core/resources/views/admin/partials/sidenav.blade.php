    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{ route('admin.dashboard') }}" class="sidebar__main-logo"><img
                    src="{{ getImage(getFilePath('logoIcon') . '/logo_2.png') }}" alt="@lang('image')"></a>
        </div>
            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.product*', 3) }}">
                        <i class="menu-icon fas  la-box"></i>
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.product*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.product.active') }} ">
                                <a href="{{ route('admin.product.active') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.product.trend') }} ">
                                <a href="{{ route('admin.product.trend') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Trend')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.store-category.all') }}">
                    <a href="{{ route('admin.store-category.all') }}" class="nav-link ">
                        <i class="menu-icon las la-bars"></i>
                        <span class="menu-title">@lang('Stores Categories')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.referrals*', 3) }}">
                        <i class="menu-icon las la-user-friends"></i>
                        <span class="menu-title">@lang('Referrals')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.referrals*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.referrals.all') }} ">
                                <a href="{{ route('admin.referrals.all') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Referrals')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.referrals.confirmed') }} ">
                                <a href="{{ route('admin.referrals.confirmed') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Confirmed Referrals')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{ menuActive('admin.referrals.pending') }}">
                                <a href="{{ route('admin.referrals.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Referrals')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.referrals.cancelled') }}">
                                <a href="{{ route('admin.referrals.cancelled') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cancelled Referrals')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.transactions*', 3) }}">
                        <i class="menu-icon las la-exchange-alt"></i>
                        <span class="menu-title">@lang('Tranactions')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.transactions*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.transactions.all') }} ">
                                <a href="{{ route('admin.transactions.all') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Tranactions')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.transactions.confirmed') }} ">
                                <a href="{{ route('admin.transactions.confirmed') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Confirmed Tranactions')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{ menuActive('admin.transactions.pending') }}">
                                <a href="{{ route('admin.transactions.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Tranactions')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.transactions.cancelled') }}">
                                <a href="{{ route('admin.transactions.cancelled') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Cancelled Tranactions')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.claims.*', 3) }}">
                        <i class="menu-icon las la-tasks"></i>
                        <span class="menu-title">@lang('Claims')</span>
                        @if (0 < $pendingClaimsCount)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.claims.*', 2) }} ">
                        <ul>

                            <li class="sidebar-menu-item {{ menuActive('admin.claims.pending') }}">
                                <a href="{{ route('admin.claims.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Claim Requests')</span>
                                    @if ($pendingClaimsCount)
                                        <span
                                            class="menu-badge pill bg--danger ms-auto">{{ $pendingClaimsCount }}</span>
                                    @endif
                                </a>
                            </li>


                            <li class="sidebar-menu-item {{ menuActive('admin.claims.approved') }} ">
                                <a href="{{ route('admin.claims.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Claims')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.claims.rejected') }} ">
                                <a href="{{ route('admin.claims.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Claims')</span>
                                </a>
                            </li>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.withdraw.pending') }}">
                                <a href="{{ route('admin.withdraw.pending') }}" class="nav-link">
                                    ...
                                    @if ($pendingWithdrawalsCount)
                                        <span
                                            class="menu-badge pill bg--danger ms-auto">{{ $pendingWithdrawalsCount }}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.withdraw.approved') }} ">
                                <a href="{{ route('admin.withdraw.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Withdrawal')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.withdraw.rejected') }} ">
                                <a href="{{ route('admin.withdraw.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Withdrawal')</span>
                                </a>
                            </li>


                            <li class="sidebar-menu-item {{ menuActive('admin.withdraw.list') }}">
                                <a href="{{ route('admin.withdraw.list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Withdrawal')</span>
                                </a>
                            </li>
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.frontend.sections*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="{{ route('admin.frontend.banners') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
